...
public class FileResource {
     ...
     * 
     * @throws  if no file is selected by the user
     */
    public FileResource () {
        initRead();
    }
     ...
     * @throws  if the file cannot be accessed
     */
     ...
     * @throws  if the filename cannot be accessed
     */
     ...
     *         time
     * @throws  if this file does not represent a CSV formatted data
     */
